...
class OCRServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ProcessBatchImages = channel.unary_unary(
                '/ocr.OCRService/ProcessBatchImages',
                request_serializer=ocr__service__pb2.BatchImageRequest.SerializeToString,
                response_deserializer=ocr__service__pb2.BatchOCRResponse.FromString,
                _registered_method=True)
...
def add_OCRServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ProcessBatchImages': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=ocr__service__pb2.BatchImageRequest.FromString,
                    response_serializer=ocr__service__pb2.BatchOCRResponse.SerializeToString,
            ),
    }
...
class OCRService(object):
    ...
    @staticmethod
    def ProcessBatchImages(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/ocr.OCRService/ProcessBatchImages',
            ocr__service__pb2.BatchImageRequest.SerializeToString,
            ocr__service__pb2.BatchOCRResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
